...
namespace EmergencyCallouts.Essential
{
    ...
    internal static class Helper
    {
        ...
        internal static class Handle
        {
            ...
            #region CommitSuidide
            // Full credit: TomGrobbe/vMenu (Modified to ignore extension methods)
            public static async void CommitSuicide(Ped ped)
            {
                ...
                if (MainPlayer.Inventory.EquippedWeapon == "WEAPON_PISTOL_MK2")
                {
                    weaponHash = "WEAPON_PISTOL_MK2";
                }
                else if (MainPlayer.Inventory.EquippedWeapon == "WEAPON_COMBATPISTOL")
                {
                    weaponHash = "WEAPON_COMBATPISTOL";
                }
                else if (MainPlayer.Inventory.EquippedWeapon == "WEAPON_PISTOL")
                {
                    weaponHash = "WEAPON_PISTOL";
                }
                else if (MainPlayer.Inventory.EquippedWeapon == "WEAPON_SNSPISTOL_MK2")
                {
                    weaponHash = "WEAPON_SNSPISTOL_MK2";
                }
                else if (MainPlayer.Inventory.EquippedWeapon == "WEAPON_SNSPISTOL")
                {
                    weaponHash = "WEAPON_SNSPISTOL";
                }
                else if (MainPlayer.Inventory.EquippedWeapon == "WEAPON_PISTOL50")
                {
                    weaponHash = "WEAPON_PISTOL50";
                }
                else if (MainPlayer.Inventory.EquippedWeapon == "WEAPON_HEAVYPISTOL")
                {
                    weaponHash = "WEAPON_HEAVYPISTOL";
                }
                else if (MainPlayer.Inventory.EquippedWeapon == "WEAPON_VINTAGEPISTOL")
                {
                ...
                {
                    ped.GiveRandomHandgun(-1, true);
                    ped.DropsCurrentWeaponOnDeath = true;
                }
                else
                {
                    ped.GiveRandomHandgun(-1, true);
                ...
                ped.Tasks.PlayAnimation(new AnimationDictionary("mp_suicide"), "pistol", 4f, AnimationFlags.UpperBodyOnly);
                GameFiber.Sleep(700);

                ped.Tasks.FireWeaponAt(ped, 1, FiringPattern.SingleShot);
