        ...
        private void CheckForDamage()
        {
            ...
            GameFiber.StartNew(delegate
            {
                ...
                while (CalloutActive)
                {
                    ...
                    {
                        Game.DisplayHelp($"Press {Settings.InteractKey} to look for any ~y~property damage~s~.");
                        ...
                        if (Game.IsKeyDown(Settings.InteractKey))
                        {
                            ...
                            // Attach Clipboard
                            int lhBoneIndex = NativeFunction.Natives.GET_PED_BONE_INDEX<int>(MainPlayer, (int)PedBoneId.RightPhHand);
                            NativeFunction.Natives.ATTACH_ENTITY_TO_ENTITY(Clipboard, MainPlayer, lhBoneIndex, 0f, 0f, 0f, 0f, 0f, 0f, true, true, false, false, 2, 1);

                            // Attach Pencil
                            int rhBoneIndex = NativeFunction.Natives.GET_PED_BONE_INDEX<int>(MainPlayer, (int)PedBoneId.LeftPhHand);
                            NativeFunction.Natives.ATTACH_ENTITY_TO_ENTITY(Clipboard, MainPlayer, rhBoneIndex, 0f, 0f, 0f, 0f, 0f, 0f, true, true, false, false, 2, 1);
