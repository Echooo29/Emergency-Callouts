    ...
    public class SuspiciousActivity : Callout
    {
        ...
        private void Scenario3() // In-Vehicle Drug Deal
        {
            ...
            try
            {
                ...
                Game.LogTrivial("[Emergency Callouts]: Warped Suspect2 into Suspect2Vehicle");
        ...
        private void Scenario4() // Suspect Searching Trunk
        {
            ...
            try
            {
                ...
                Game.LogTrivial("[Emergency Callouts]: Cleared Suspect inventory");
                ...
                Game.LogTrivial("[Emergency Callouts]: Assigned Suspect2 to play animation");
                        ...
                        if (MainPlayer.Position.DistanceTo(Suspect.Position) < 3f)
                        {
                            if (Game.IsKeyDown(Settings.TalkKey))
                            {
                                ...
                                if (line == dialogue.Length)
                                {
                                    ...
                                    Play.CodeFourAudio();
                                    Game.LogTrivial("[Emergency Callouts]: Played code four audio");
        ...
        private void Scenario5() // Ripdeal
        {
            ...
            try
            {
                ...
                Suspect2.Health = 110;
                Game.LogTrivial("[Emergency Callouts]: Set Suspect health to 150");
        ...
        public override void Process()
        {
            ...
            {
                Check.EndKeyDown();
                Check.PreventDistanceCrash(CalloutPosition, PlayerArrived, FoundPed);
                ...
                #region OnPedFound
                if (MainPlayer.Position.DistanceTo(Suspect.Position) < 5f && FoundPed == false && PlayerArrived == true && Suspect.Exists())
                {
                    // Set PedFound
                    FoundPed = true;
                ...
                if (MainPlayer.Position.DistanceTo(Suspect2.Position) < 5f && FoundPed2 == false && PlayerArrived == true && Suspect2.Exists())
                {
                    // Set FoundPed2
                    FoundPed2 = true;
                    Game.LogTrivial("[Emergency Callouts]: Found Suspect2");
                    ...
                    // Enable Suspect2Blip
                    Entity.Enable(SuspectBlip);
                    Game.LogTrivial("[Emergency Callouts]: Enabled Suspect2Blip");
